...
const StatCard = ({ title, value, icon: Icon, color }) => (
  <div className="bg-white dark:bg-slate-900 p-6 flex items-center gap-5 rounded-2xl border border-slate-200 dark:border-purple-500/20 shadow-glow hover:scale-[1.02] transition-transform cursor-default">
