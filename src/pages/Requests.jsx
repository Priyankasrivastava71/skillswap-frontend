              ...
              {activeTab === "incoming" && req.status === "pending" && (
                <>
                  <button
                    ...
                    className="bg-green-500/20 text-green-500 px-4 py-2 rounded-xl hover:bg-green-500/30 transition"
                  >
                    Accept
                  </button>
                  ...
                  <button
                    ...
                    className="bg-red-500/20 text-red-500 px-4 py-2 rounded-xl hover:bg-red-500/30 transition"
                  >
                    Reject
                  </button>
                </>
